  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      <aside
        ...
        } fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-md transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:h-auto`}
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center px-10 py-6 border-b dark:border-gray-700">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 rounded-lg ${
                      isActive ? 'bg-primary-50 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'hover:bg-gray-100 dark:hover:bg-gray-700'
                    }`
                  }
                  end
                >
          ...
          <div className="px-4 py-6 border-t dark:border-gray-700">
            <button
              onClick={logout}
              className="flex items-center w-full px-4 py-3 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
            >
        ...
        <header className="bg-white dark:bg-gray-800 shadow-sm z-10">
          <div className="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center">
              <button className="p-1 rounded-full text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 mr-3">
              ...
              <div className="relative flex items-center">
                ...
                <span className="ml-2 font-medium text-gray-700 dark:text-gray-300">{user?.nome || 'Usuário'}</span>
              </div>
            </div>
          </div>
        </header>
